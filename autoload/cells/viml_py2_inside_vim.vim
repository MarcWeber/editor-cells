...
fun! cells#viml_py2_inside_vim#setupPython(py_cmd) abort
  if has(a:py_cmd)
    let py = [
          \ 'import sys',
          \ 'import vim',
    ...
    call cells#viml_py2_inside_vim#vim8_VimEventToPy(a:py_cmd)
  else
    echoe "py ".a:py_cmd." not supported by this Vim"
  endif
endf

fun! cells#viml_py2_inside_vim#vim8_VimEventToPy(py_cmd) abort
