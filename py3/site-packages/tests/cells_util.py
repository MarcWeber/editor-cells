...
class TestPy3AsyncIO(unittest.TestCase):
    ...
    def testExternalAsyncIOTestScript(self):
        ...
        dicts.append(merge_dicts_cow(other_network, {'type': 'cell_new_by_name', 'name': 'cells.asyncio.mock.ProjectCell', 'args': [], 'kargs': {'project_files': [os.path.abspath(__file__)], 'id': 'ProjectCell'}}))
        dicts.append(merge_dicts_cow(other_network, {'type': 'cell_new_by_name', 'name': 'cells.asyncio.mock.Editor', 'args': [], 'kargs': {'id': 'Editor'}}))
        # completion cell
        dicts.append(merge_dicts_cow(other_network, {'type': 'cell_new_by_name', 'name': 'cells.asyncio.examples.CompletionBasedOnFiles', 'args': [], 'kargs': {'id': 'CompletionBasedOnFiles'}}))
        # completion request
