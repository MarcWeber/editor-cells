...
class JsonRPC():
    ...
    def __init__(self, connection_properties, init_calls = [], wait_for_server_messages = True, async_log_unexpected_message = None, log_writer = None, log_reader = None, id_key = "id", reply_id_key = "id"):
        self.id = 1
