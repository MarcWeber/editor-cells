...
class Editor(cells.Cell):
    ...
    def __init__(self):
        ...
        self.buffers = {'buffer1': {'bufid': 'buffer1', 'filepath': '/does-hopefully-not-exist.txt', 'lines': ['abc', 'foo', 'bar']}}

    async def l_command(self, event):
        raise Exception('TODO')
        # buffers = []
        # for b in self.buffers.values():
        #     buffers.append({'bufid': b['bufid'], 'filepath': b['filename']})
