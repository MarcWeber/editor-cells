...
class WatchCmdErrors(cells_a.Cell):
    ...
    \         'cells.asyncio.error_line_parsers.line_parser_ruby',
    \ ]
    call g:bridge_cell.cell_new_by_name({'name': 'cells.asyncio.watch_cmd_errors.WatchCmdErrors', 'args': [], 'kwargs': {'id': 'py:external_process', 'cmd': 'irb', 'stdin_data': load_cmd, 'error_line_parsers' : error_line_parsers}})
