...
class CompletionBasedOnFiles(cells_a.Cell):
    ...
    async def completions(self, oe):
        ...
        files_open_in_vim = sum([[x['filepath'] for x in result['buffers']] for result in files_open_in_vim], [])
        ...
        # TODO get lines of buffers not having a filepath (which are not on disk)
